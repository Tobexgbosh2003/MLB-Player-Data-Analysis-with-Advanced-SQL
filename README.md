...
⚾ MLB Player Data Analysis with Advanced SQL
🎯 Project Title
Advanced SQL Querying for Major League Baseball (MLB) Player and Team Analysis


Project Overview
I was hired as a Data Analyst Intern for Major League Baseball (MLB) to analyze a large dataset of historical player and team statistics. The primary goal was to leverage advanced SQL querying techniques—including Window Functions, CTEs, Joins, Aggregation, and Datetime functions—to track how player attributes and team spending have evolved over decades within the league.
...
I. School Analysis
This section focused on answering the first project objective: "What schools do MLB players attend?"
...
II. Salary Analysis
This section tackled the second objective: "How much do teams spend on player salaries?"
...
This part addressed the third objective: "What does each player's career look like?"
...
The final section completed the fourth objective: "How do player attributes compare?"
...
Common Table Expressions (CTEs): Used extensively for structuring complex, multi-step queries (e.g., in tasks involving cumulative sums and ranking).
